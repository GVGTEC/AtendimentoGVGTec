...
namespace UI
{
    public partial class frmFilialPesquisar : Form
    {
        ...
        //Esta propriedade devolve o ID Filial para o formulario anterior
        public int IdCliente { get; set; }

        private void frmFilialPesquisar_Load(object sender, EventArgs e)
        {
        ...
        public void CarregarGrid()   //http://www.macoratti.net/10/11/c_efcrud.htm
        {
            try
            {
                ...
                IEnumerable<Filial> lista = from c in contexto.FilialCtx select c;
        ...
        {
            frmFilialPesquisar_Load(sender, e);
        }
