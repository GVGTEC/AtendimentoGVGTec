...
namespace UI
{
    public partial class frmAtendentePesquisar : Form
    {
        public frmAtendentePesquisar()
        {
            InitializeComponent();
        }

        //Esta propriedade devolve o ID Atendente para o formulario anterior
        public int IdAtendente { get; set; }

        private void frmAtendentesPesquisar_Load(object sender, EventArgs e)
        {
        ...
        public void ConfiguraDataGridView()
        {
            ...
            dgvPesquisar.Columns[1].Width = 530;
        ...
        public void CarregarGrid()   //http://www.macoratti.net/10/11/c_efcrud.htm
        {
            try
            {
                ...
                IEnumerable<Atendente> lista = from c in contexto.AtendenteCtx select c;

                dgvPesquisar.DataSource = lista.ToList();

                //dgvPesquisar.Columns["codigo"].DataPropertyName = "AtendenteId";
        ...
        private void frmAtendentePesquisar_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            frmAtendentesPesquisar_Load(sender, e);
        }
